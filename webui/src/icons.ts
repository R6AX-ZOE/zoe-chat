// 统一自绘 SVG 图标集:24×24 viewBox、stroke 1.5、圆角线帽/线接、平滑路径。
// 设计约束:禁止使用 emoji 作图标。装饰图标由调用方加 aria-hidden。

const P = (paths: string): string =>
...
const ICONS: Record<string, string> = {
  ...
  shield: P(
    `<path d="M12 3 20 6.6v5.2c0 4.3-3.3 7.5-8 9.2-4.7-1.7-8-4.9-8-9.2V6.6L12 3Z"/>` +
      `<path d="m8.8 11.8 2.4 2.4 4.2-4.4"/>`,
  ),
  users: P(
    `<circle cx="9" cy="8" r="3.4"/><path d="M3.2 20a5.8 5.8 0 0 1 11.6 0"/>` +
  ...
  key: P(
    `<circle cx="8" cy="15" r="4"/><path d="m10.8 12.2 9.2-9.2M16 6.5l2.5 2.5M12.8 9.2l2.5 2.5"/>`,
  ),
  radio: P(
